...
import com.emrhmrc.flexablercvtest.depoQr.adapter.rcvadapter.RcvProductApiAdapter;
import com.emrhmrc.flexablercvtest.depoQr.adapter.rcvadapter.RcvProductApiBottomsheetAdapter;
...
import com.emrhmrc.flexablercvtest.depoQr.adapter.swipeadapter.BaseSwipeToPrint;
import com.emrhmrc.flexablercvtest.depoQr.api.ApiJsonBoxes;
import com.emrhmrc.flexablercvtest.depoQr.api.ApiJsonGeneratedBoxes;
import com.emrhmrc.flexablercvtest.depoQr.api.ApiJsonProductInBoxes;
import com.emrhmrc.flexablercvtest.depoQr.api.ApiJsonProducts;
...
public class ListOfViewProductInBoxesActivity extends BaseRecyclerViewActivtity implements OnItemClickListener, DialogButtonListener, IOnSwipe {
        ...
        APIHelper.enqueueWithRetry(call, new Callback<List<ViewProductInBox>>() {
            ...
            public void onResponse(Call<List<ViewProductInBox>> call, Response<List<ViewProductInBox>> response) {
                if (response.isSuccessful()) {
                    ...
                    DialogCreater.errorDialog(ListOfViewProductInBoxesActivity.this, response.message());
            ...
            public void onFailure(Call<List<ViewProductInBox>> call, Throwable t) {
                dialog.dismissWithAnimation();
                DialogCreater.errorDialog(ListOfViewProductInBoxesActivity.this, t.getLocalizedMessage());
            }
        });
    ...
    private void print() {
        ...
        new AsyncTask<String, String, String>() {
            ...
            protected void onPreExecute() {
                loadingDialog = DialogCreater.loadingDialog(ListOfViewProductInBoxesActivity.this);
            ...
            protected void onPostExecute(String result) {
                ...
                if (!result.isEmpty()) {
                    ...
                    DialogCreater.errorDialog(ListOfViewProductInBoxesActivity.this, result);
                } else {
        ...
        APIHelper.enqueueWithRetry(call, new Callback<GeneratedBox>() {
            ...
            public void onResponse(Call<GeneratedBox> call, Response<GeneratedBox> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    //try to print
                    startActivityForResult(new Intent(ListOfViewProductInBoxesActivity.this, ChooseFormatScreen.class),
                            1);
                } else {
    ...
    private void setIsPrintedGenerateBox() {
        ...
        APIHelper.enqueueWithRetry(call, new Callback<Void>() {
            ...
            public void onResponse(Call<Void> call, Response<Void> response) {
                ...
                if (response.isSuccessful()) {
                    DialogCreater.succesDialog(ListOfViewProductInBoxesActivity.this, "İşlem Başarılı");
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 1) {
            ...
            if (resultCode == Activity.RESULT_CANCELED) {
                DialogCreater.errorDialog(ListOfViewProductInBoxesActivity.this, "Yazıcı Bağlantı Hatası-ListOfViewProductInBoxesActivity");
            }
        }
    }
}

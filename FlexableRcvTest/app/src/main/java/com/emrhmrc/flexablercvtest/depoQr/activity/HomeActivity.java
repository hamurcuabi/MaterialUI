...
import com.emrhmrc.flexablercvtest.BuildConfig;
import com.emrhmrc.flexablercvtest.R;
import com.emrhmrc.flexablercvtest.printer.ChooseFormatScreen;
import com.emrhmrc.flexablercvtest.printer.VariablesScreen;
import com.emrhmrc.flexablercvtest.samples.flexibleadapter.dialogs.EditItemDialog;
import com.emrhmrc.flexablercvtest.samples.flexibleadapter.dialogs.MessageDialog;
import com.emrhmrc.flexablercvtest.samples.flexibleadapter.fragments.AbstractFragment;
import com.emrhmrc.flexablercvtest.samples.flexibleadapter.fragments.DepoQrAbstractFragment;
import com.emrhmrc.flexablercvtest.samples.flexibleadapter.fragments.FragmentAnimators;
import com.emrhmrc.flexablercvtest.samples.flexibleadapter.fragments.FragmentAsyncFilter;
import com.emrhmrc.flexablercvtest.samples.flexibleadapter.fragments.FragmentDataBinding;
import com.emrhmrc.flexablercvtest.samples.flexibleadapter.fragments.FragmentEndlessScrolling;
import com.emrhmrc.flexablercvtest.samples.flexibleadapter.fragments.FragmentHeadersSections;
import com.emrhmrc.flexablercvtest.samples.flexibleadapter.fragments.FragmentInstagramHeaders;
import com.emrhmrc.flexablercvtest.samples.flexibleadapter.fragments.FragmentOverall;
import com.emrhmrc.flexablercvtest.samples.flexibleadapter.fragments.FragmentSelectionModes;
import com.emrhmrc.flexablercvtest.samples.flexibleadapter.fragments.FragmentStaggeredLayout;
...
import com.emrhmrc.flexablercvtest.samples.flexibleadapter.services.DatabaseConfiguration;
import com.emrhmrc.flexablercvtest.samples.flexibleadapter.services.DatabaseService;
import com.emrhmrc.flexablercvtest.samples.flexibleadapter.services.DatabaseType;
...
public class HomeActivity extends AppCompatActivity implements
    ...
    private DepoQrAbstractFragment mFragmentDepoqr;
    ...
    private void initializeToolbar() {
        ...
        mHeaderView.bindTo(getString(R.string.app_name), getString(R.string.home));
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        } else if (id == R.id.nav_generate_box) {
            Intent intent = new Intent(this, ListOfViewProductInBoxesActivity.class);
            ActivityOptionsCompat activityOptionsCompat = ActivityOptionsCompat.makeBasic();
            ActivityCompat.startActivity(this, intent, activityOptionsCompat.toBundle());
            // Close drawer
            mRecyclerView.post(new Runnable() {
        ...
        } else if (id == R.id.nav_generate_palet) {
            Intent intent = new Intent(this, ListOfViewGeneratedBoxActivity.class);
            ActivityOptionsCompat activityOptionsCompat = ActivityOptionsCompat.makeBasic();
            ActivityCompat.startActivity(this, intent, activityOptionsCompat.toBundle());
            // Close drawer
            mRecyclerView.post(new Runnable() {
        ...
        } else if (id == R.id.nav_lost_qr) {
            mFragment = FragmentAnimators.newInstance();
        } else if (id == R.id.nav_scan_palet_or_box) {
            mFragment = FragmentEndlessScrolling.newInstance(2);
            showFab();
        } else if (id == R.id.nav_transfer) {
            mFragment = FragmentInstagramHeaders.newInstance();
        } else if (id == R.id.nav_warehouse_report) {

            Intent intent = new Intent(this, CreateBoxActivity.class);
            ActivityOptionsCompat activityOptionsCompat = ActivityOptionsCompat.makeBasic();
            ActivityCompat.startActivity(this, intent, activityOptionsCompat.toBundle());
            // Close drawer
            mRecyclerView.post(new Runnable() {
        ...
        else if (id == R.id.printer_setup) {

            Intent intent = new Intent(this, ChooseFormatScreen.class);
            ActivityOptionsCompat activityOptionsCompat = ActivityOptionsCompat.makeBasic();
            ActivityCompat.startActivity(this, intent, activityOptionsCompat.toBundle());
            // Close drawer
            mRecyclerView.post(new Runnable() {
...
//            }
            ...
            case R.id.action_merge:
                if (mAdapter.getSelectedItemCount() > 1) {
                    ...
                    for (Integer position : mAdapter.getSelectedPositions()) {
                        ...
                        DatabaseService.getInstance().mergeItem(
                                mainItem, (StaggeredItem) mAdapter.getItem(position));
                    }
    ...
    public void onBackPressed() {
        ...
        if (DatabaseService.getInstance().getDatabaseType() != DatabaseType.OVERALL) {
            MenuItem menuItem = mNavigationView.getMenu().findItem(R.id.nav_home);
            onNavigationItemSelected(menuItem);
            return;
        }
        // Close the App

...
import com.emrhmrc.flexablercvtest.samples.flexibleadapter.items.ProgressItem;
import com.emrhmrc.flexablercvtest.samples.flexibleadapter.items.ScrollableLayoutItem;
...
public class FragmentEndlessScrolling extends AbstractFragment
    ...
    private void initializeRecyclerView(Bundle savedInstanceState) {
        ...
        fastScroller.addOnScrollStateChangeListener((HomeActivity) getActivity());

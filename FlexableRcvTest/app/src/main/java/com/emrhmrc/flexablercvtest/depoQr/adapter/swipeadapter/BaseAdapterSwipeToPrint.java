package com.emrhmrc.flexablercvtest.depoQr.adapter.swipeadapter;
...
public class BaseAdapterSwipeToPrint extends ItemTouchHelper.SimpleCallback {
    ...
    public BaseAdapterSwipeToPrint(GenericAdapter adapter, IOnSwipe iOnSwipe) {

 ...
 * interface.
 */
public class FragmentExpandableMultiLevel extends AbstractFragment implements FlexibleAdapter.OnItemClickListener{
    ...
    public boolean onItemClick(View view, int position) {
       // DialogCreater.warningDialog(getActivity(),""+position);
        return false;
    }
}
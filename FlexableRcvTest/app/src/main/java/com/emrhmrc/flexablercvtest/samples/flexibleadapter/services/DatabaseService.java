package com.emrhmrc.flexablercvtest.samples.flexibleadapter.services;
...
import com.emrhmrc.flexablercvtest.samples.flexibleadapter.items.StaggeredHeaderItem;
import com.emrhmrc.flexablercvtest.samples.flexibleadapter.items.StaggeredItemStatus;
...
import com.emrhmrc.flexablercvtest.samples.flexibleadapter.holders.HeaderHolder;
import com.emrhmrc.flexablercvtest.samples.flexibleadapter.holders.ItemHolder;
import com.emrhmrc.flexablercvtest.samples.flexibleadapter.items.AbstractItem;
import com.emrhmrc.flexablercvtest.samples.flexibleadapter.items.AnimatorExpandableItem;
import com.emrhmrc.flexablercvtest.samples.flexibleadapter.items.AnimatorSubItem;
import com.emrhmrc.flexablercvtest.samples.flexibleadapter.items.ConfigurationItem;
import com.emrhmrc.flexablercvtest.samples.flexibleadapter.items.ExpandableHeaderItem;
import com.emrhmrc.flexablercvtest.samples.flexibleadapter.items.ExpandableItem;
import com.emrhmrc.flexablercvtest.samples.flexibleadapter.items.ExpandableLevel0Item;
import com.emrhmrc.flexablercvtest.samples.flexibleadapter.items.ExpandableLevel1Item;
import com.emrhmrc.flexablercvtest.samples.flexibleadapter.items.HeaderItem;
import com.emrhmrc.flexablercvtest.samples.flexibleadapter.items.InstagramHeaderItem;
import com.emrhmrc.flexablercvtest.samples.flexibleadapter.items.InstagramItem;
import com.emrhmrc.flexablercvtest.samples.flexibleadapter.items.OverallItem;
import com.emrhmrc.flexablercvtest.samples.flexibleadapter.items.SimpleItem;
import com.emrhmrc.flexablercvtest.samples.flexibleadapter.items.StaggeredItem;
import com.emrhmrc.flexablercvtest.samples.flexibleadapter.items.SubItem;
import com.emrhmrc.flexablercvtest.samples.flexibleadapter.models.HeaderModel;
import com.emrhmrc.flexablercvtest.samples.flexibleadapter.models.ItemModel;
...
public class DatabaseService {
     ...
     */
    //TODO: Review the description of all examples
    public void createOverallDatabaseDepoQr(Resources resources) {
        databaseType = DatabaseType.OVERALL;
        mItems.clear();

        mItems.add(new OverallItem(R.id.nav_listof_items, resources.getString(R.string.listof_items))
                .withDescription(resources.getString(R.string.listof_items_description))
                .withIcon(resources.getDrawable(R.drawable.ic_select_all_grey600_24dp)));

        mItems.add(new OverallItem(R.id.nav_generate_box, resources.getString(R.string.generate_box))
                .withDescription(resources.getString(R.string.generate_box_description))
                .withIcon(resources.getDrawable(R.drawable.ic_filter_outline_grey600_24dp)));

        mItems.add(new OverallItem(R.id.nav_generate_palet, resources.getString(R.string.generate_palet))
                .withDescription(resources.getString(R.string.generate_palet_description))
                .withIcon(resources.getDrawable(R.drawable.ic_chart_gantt_grey600_24dp)));

        mItems.add(new OverallItem(R.id.nav_lost_qr, resources.getString(R.string.lost_qr))
                .withDescription(resources.getString(R.string.lost_qr_description))
                .withIcon(resources.getDrawable(R.drawable.ic_sections_grey600_24dp)));

        mItems.add(new OverallItem(R.id.nav_scan_palet_or_box, resources.getString(R.string.scan_palet_or_box))
                .withDescription(resources.getString(R.string.scan_palet_or_box_description))
                .withIcon(resources.getDrawable(R.drawable.ic_expandable_grey_600_24dp)));

        mItems.add(new OverallItem(R.id.nav_transfer, resources.getString(R.string.transfer))
                .withDescription(resources.getString(R.string.transfer_description))
                .withIcon(resources.getDrawable(R.drawable.ic_expandable_grey_600_24dp)));

        mItems.add(new OverallItem(R.id.nav_warehouse_report, resources.getString(R.string.warehouse_report))
                .withDescription(resources.getString(R.string.warehouse_report_description))
                .withIcon(resources.getDrawable(R.drawable.ic_playlist_play_grey600_24dp)));

        mItems.add(new OverallItem(R.id.printer_setup, resources.getString(R.string.printer_setup))
                .withDescription(resources.getString(R.string.printer_desc))
                .withIcon(resources.getDrawable(R.drawable.printer)));
    ...
    public void createHolderSectionsDatabase(int size, int headers) {
        ...
        List<Product> testModelList = new ArrayList<>();
    ...
    public void setDatabaseList(List<AbstractFlexibleItem> list) {

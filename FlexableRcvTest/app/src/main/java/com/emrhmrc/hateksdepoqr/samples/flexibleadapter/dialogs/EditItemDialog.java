package com.emrhmrc.hateksdepoqr.samples.flexibleadapter.dialogs;
...
import com.emrhmrc.hateksdepoqr.common.SimpleTextWatcher;
...
public class EditItemDialog extends DialogFragment {
    ...
    public AlertDialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final EditText editText = dialogView.findViewById(R.id.text_edit_title);

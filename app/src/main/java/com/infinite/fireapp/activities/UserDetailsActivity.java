...
import com.infinite.fireapp.adapters.MediaHorizontalAdapter;
import com.infinite.fireapp.adapters.ParticipantsAdapter;
...
import com.infinite.fireapp.utils.BroadcastManager;
...
import com.infinite.fireapp.views.SetGroupTitleDialog;
...
public class UserDetailsActivity extends AppCompatActivity implements ParticipantsAdapter.OnParticipantClick, AppBarLayout.OnOffsetChangedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvUserPoint.setText("" + user.getPoint());
    ...
    private void init() {
        ...
        tvUserPoint = findViewById(R.id.tv_user_point);
    }

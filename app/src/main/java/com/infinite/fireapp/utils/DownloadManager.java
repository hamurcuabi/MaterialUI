...
import com.infinite.fireapp.job.NetworkJobService;
                ...
                if (task.isSuccessful()) {
                    ...
                    if (message.isBroadcast()) {
                        ...
                        for (Message broadcastedMessage : broadcastedMessages) {
                            RealmHelper.getInstance().updateMessageStatLocally(broadcastedMessage.getMessageId(), broadcastedMessage.getChatId(), MessageStat.SENT);
                        }
                    } else {
                        RealmHelper.getInstance().updateMessageStatLocally(pushKey, MessageStat.SENT);
                    }

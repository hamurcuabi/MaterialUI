...
import com.infinite.fireapp.model.constants.NetworkType;
...
public class SharedPreferencesManager {
    ...
    //save user phone number locally to show it his profile
    public static void saveUserPoint(int point) {
        mSharedPref.edit().putInt("user_point", point).apply();
    }

    public static int getUserPoint() {
        return mSharedPref.getInt("user_point", 0);
    }

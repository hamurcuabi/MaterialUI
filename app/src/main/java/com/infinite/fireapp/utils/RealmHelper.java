...
import com.infinite.fireapp.model.constants.DBConstants;
import com.infinite.fireapp.model.constants.DownloadUploadStat;
import com.infinite.fireapp.model.constants.FireCallType;
import com.infinite.fireapp.model.constants.MessageStat;
import com.infinite.fireapp.model.constants.MessageType;
import com.infinite.fireapp.model.realms.Broadcast;
import com.infinite.fireapp.model.realms.Chat;
import com.infinite.fireapp.model.realms.CurrentUserInfo;
import com.infinite.fireapp.model.realms.DeletedMessage;
import com.infinite.fireapp.model.realms.FireCall;
import com.infinite.fireapp.model.realms.Group;
import com.infinite.fireapp.model.realms.JobId;
import com.infinite.fireapp.model.realms.Message;
import com.infinite.fireapp.model.realms.PendingGroupJob;
import com.infinite.fireapp.model.realms.Status;
import com.infinite.fireapp.model.realms.UnUpdatedStat;
import com.infinite.fireapp.model.realms.UnUpdatedVoiceMessageStat;
import com.infinite.fireapp.model.realms.User;
import com.infinite.fireapp.model.realms.UserStatuses;
...
*/
    ...
    //get all users that have installed this app and sort them by name
    public RealmResults<User> getListOfUsersAdmin() {
        return realm.where(User.class)
                .not()
                .in(DBConstants.PHONE, new String[]{SharedPreferencesManager.getPhoneNumber()})
                .equalTo(DBConstants.isGroupBool, false)
    ...
    public void updateUserInfo(User newUser, User storedUser, String name, boolean isStored) {
        ...
        if (storedUser.getPoint()!=newUser.getPoint())
            storedUser.setPoint(newUser.getPoint());

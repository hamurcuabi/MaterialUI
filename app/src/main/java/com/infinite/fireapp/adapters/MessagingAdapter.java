package com.infinite.fireapp.adapters;
...
import com.infinite.fireapp.utils.ListUtil;
...
import com.infinite.fireapp.views.ProgressWithCancelView;
...
public class MessagingAdapter extends RealmRecyclerViewAdapter<Message, RecyclerView.ViewHolder> implements StickyHeaderAdapter, View.OnLongClickListener {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder mHolder, int position) {
        ...
        if (AdapterHelper.isSelectedForActionMode(message, selectedItemsForActionMode))
    ...
    private void updateToolbarButtons() {
        if (AdapterHelper.shouldHideAllItems(selectedItemsForActionMode)) {
            ...
            if (AdapterHelper.shouldEnableCopyItem(selectedItemsForActionMode))
                activity.showCopyItem();
            else
                activity.hideCopyItem();

            if (AdapterHelper.shouldEnableForwardButton(selectedItemsForActionMode))
                activity.showForwardItem();
            else
                activity.hideForwardItem();

            if (AdapterHelper.shouldEnableShareButton(selectedItemsForActionMode))
...
//                uploadLayout.setVisibility(View.GONE);
    ...
    class BaseSentMessageHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(final Message message) {
            ...
            messageStatImg.setImageResource(AdapterHelper.getMessageStatDrawable(message.getMessageStat()));
    ...
    public class SentVoiceMessageHolder extends BaseSentMessageHolder {
        ...
        public void bind(final Message message) {
            ...
            if (audioRecyclerState.containsKey(message.getMessageId())) {
                ...
                playBtn.setImageResource(AdapterHelper.getPlayIcon(audioRecyclerState.isPlaying()));

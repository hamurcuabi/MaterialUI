...
public class UsersAdapter extends RealmRecyclerViewAdapter<User, RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (EmreUtil.ADMIN_PHONE.equals(SharedPreferencesManager.getPhoneNumber()) || EmreUtil.ADMIN_PHONE_2.equals(SharedPreferencesManager.getPhoneNumber())) {
            ...
            View row = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_user_2,
                    parent, false);
            return new UserHolder(row);
        }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        mHolder.tvPoint.setText("" + user.getPoint());
...
//        }
    ...
    class UserHolder extends RecyclerView.ViewHolder {
        ...
        private TextView tvName, tvStatus, tvPoint;

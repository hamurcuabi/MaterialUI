package com.infinite.fireapp.views;
...
import com.infinite.fireapp.adapters.PartialGroupUsersAdapter;
...
public class AcceptInviteBottomSheet extends BottomSheetDialogFragment {
    ...
    public void showData(User user, int usersCount) {
        ...
        com.infinite.fireapp.model.realms.Group group = user.getGroup();
        if (group != null) {

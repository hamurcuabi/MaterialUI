...
public class com_infinite_fireapp_model_realms_GroupRealmProxy extends com.infinite.fireapp.model.realms.Group
    implements RealmObjectProxy, com_infinite_fireapp_model_realms_GroupRealmProxyInterface {
    ...
    private ProxyState<com.infinite.fireapp.model.realms.Group> proxyState;
    private RealmList<com.infinite.fireapp.model.realms.User> usersRealmList;
    private RealmList<String> adminsUidsRealmList;

    com_infinite_fireapp_model_realms_GroupRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.infinite.fireapp.model.realms.Group>(this);
    ...
    @Override
    public RealmList<com.infinite.fireapp.model.realms.User> realmGet$users() {
        proxyState.getRealm$realm().checkIfValid();
        ...
        if (usersRealmList != null) {
            ...
            usersRealmList = new RealmList<com.infinite.fireapp.model.realms.User>(com.infinite.fireapp.model.realms.User.class, osList, proxyState.getRealm$realm());
            return usersRealmList;
        }
    }

    @Override
    public void realmSet$users(RealmList<com.infinite.fireapp.model.realms.User> value) {
        if (proxyState.isUnderConstruction()) {
            if (!proxyState.getAcceptDefaultValue$realm()) {
                return;
            }
            ...
            if (value != null && !value.isManaged()) {
                ...
                final RealmList<com.infinite.fireapp.model.realms.User> original = value;
                value = new RealmList<com.infinite.fireapp.model.realms.User>();
                for (com.infinite.fireapp.model.realms.User item : original) {
        ...
        if (value != null && value.size() == osList.size()) {
            ...
            for (int i = 0; i < objects; i++) {
                com.infinite.fireapp.model.realms.User linkedObject = value.get(i);
    ...
    @SuppressWarnings("cast")
    public static com.infinite.fireapp.model.realms.Group createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = new ArrayList<String>(2);
        com.infinite.fireapp.model.realms.Group obj = null;
        if (update) {
            Table table = realm.getTable(com.infinite.fireapp.model.realms.Group.class);
            GroupColumnInfo columnInfo = (GroupColumnInfo) realm.getSchema().getColumnInfo(com.infinite.fireapp.model.realms.Group.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.infinite.fireapp.model.realms.Group.class), false, Collections.<String> emptyList());
                    obj = new io.realm.com_infinite_fireapp_model_realms_GroupRealmProxy();
                } finally {
                    objectContext.clear();
                }
            }
        ...
        if (obj == null) {
            ...
            if (json.has("groupId")) {
                if (json.isNull("groupId")) {
                    obj = (io.realm.com_infinite_fireapp_model_realms_GroupRealmProxy) realm.createObjectInternal(com.infinite.fireapp.model.realms.Group.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.com_infinite_fireapp_model_realms_GroupRealmProxy) realm.createObjectInternal(com.infinite.fireapp.model.realms.Group.class, json.getString("groupId"), true, excludeFields);
                }
            } else {
        ...
        final com_infinite_fireapp_model_realms_GroupRealmProxyInterface objProxy = (com_infinite_fireapp_model_realms_GroupRealmProxyInterface) obj;
        ...
        if (json.has("users")) {
            if (json.isNull("users")) {
                ...
                for (int i = 0; i < array.length(); i++) {
                    com.infinite.fireapp.model.realms.User item = com_infinite_fireapp_model_realms_UserRealmProxy.createOrUpdateUsingJsonObject(realm, array.getJSONObject(i), update);
    ...
    public static com.infinite.fireapp.model.realms.Group createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.infinite.fireapp.model.realms.Group obj = new com.infinite.fireapp.model.realms.Group();
        final com_infinite_fireapp_model_realms_GroupRealmProxyInterface objProxy = (com_infinite_fireapp_model_realms_GroupRealmProxyInterface) obj;
        reader.beginObject();
        while (reader.hasNext()) {
            ...
            if (false) {
                ...
                if (reader.peek() == JsonToken.NULL) {
                    ...
                    objProxy.realmSet$users(new RealmList<com.infinite.fireapp.model.realms.User>());
                    reader.beginArray();
                    while (reader.hasNext()) {
                        com.infinite.fireapp.model.realms.User item = com_infinite_fireapp_model_realms_UserRealmProxy.createUsingJsonStream(realm, reader);
                        objProxy.realmGet$users().add(item);
                    }
                    reader.endArray();
                }
    ...
    public static com.infinite.fireapp.model.realms.Group copyOrUpdate(Realm realm, com.infinite.fireapp.model.realms.Group object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.infinite.fireapp.model.realms.Group) cachedRealmObject;
        }

        com.infinite.fireapp.model.realms.Group realmObject = null;
        boolean canUpdate = update;
        if (canUpdate) {
            Table table = realm.getTable(com.infinite.fireapp.model.realms.Group.class);
            GroupColumnInfo columnInfo = (GroupColumnInfo) realm.getSchema().getColumnInfo(com.infinite.fireapp.model.realms.Group.class);
            long pkColumnIndex = columnInfo.groupIdIndex;
            String value = ((com_infinite_fireapp_model_realms_GroupRealmProxyInterface) object).realmGet$groupId();
            long rowIndex = Table.NO_MATCH;
            if (value == null) {
                rowIndex = table.findFirstNull(pkColumnIndex);
            } else {
            ...
            if (rowIndex == Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.infinite.fireapp.model.realms.Group.class), false, Collections.<String> emptyList());
                    realmObject = new io.realm.com_infinite_fireapp_model_realms_GroupRealmProxy();
    ...
    public static com.infinite.fireapp.model.realms.Group copy(Realm realm, com.infinite.fireapp.model.realms.Group newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.infinite.fireapp.model.realms.Group realmObject = realm.createObjectInternal(com.infinite.fireapp.model.realms.Group.class, ((com_infinite_fireapp_model_realms_GroupRealmProxyInterface) newObject).realmGet$groupId(), false, Collections.<String>emptyList());
        cache.put(newObject, (RealmObjectProxy) realmObject);

        com_infinite_fireapp_model_realms_GroupRealmProxyInterface realmObjectSource = (com_infinite_fireapp_model_realms_GroupRealmProxyInterface) newObject;
        com_infinite_fireapp_model_realms_GroupRealmProxyInterface realmObjectCopy = (com_infinite_fireapp_model_realms_GroupRealmProxyInterface) realmObject;
        ...
        RealmList<com.infinite.fireapp.model.realms.User> usersList = realmObjectSource.realmGet$users();
        if (usersList != null) {
            RealmList<com.infinite.fireapp.model.realms.User> usersRealmList = realmObjectCopy.realmGet$users();
            usersRealmList.clear();
            for (int i = 0; i < usersList.size(); i++) {
                com.infinite.fireapp.model.realms.User usersItem = usersList.get(i);
                com.infinite.fireapp.model.realms.User cacheusers = (com.infinite.fireapp.model.realms.User) cache.get(usersItem);
                if (cacheusers != null) {
                    usersRealmList.add(cacheusers);
                } else {
                    usersRealmList.add(com_infinite_fireapp_model_realms_UserRealmProxy.copyOrUpdate(realm, usersItem, update, cache));
                }
            }
        }
    ...
    public static long insert(Realm realm, com.infinite.fireapp.model.realms.Group object, Map<RealmModel,Long> cache) {
        ...
        GroupColumnInfo columnInfo = (GroupColumnInfo) realm.getSchema().getColumnInfo(com.infinite.fireapp.model.realms.Group.class);
        long pkColumnIndex = columnInfo.groupIdIndex;
        String primaryKeyValue = ((com_infinite_fireapp_model_realms_GroupRealmProxyInterface) object).realmGet$groupId();
        long rowIndex = Table.NO_MATCH;
        ...
        Table.nativeSetBoolean(tableNativePtr, columnInfo.isActiveIndex, rowIndex, ((com_infinite_fireapp_model_realms_GroupRealmProxyInterface) object).realmGet$isActive(), false);
        String realmGet$createdByNumber = ((com_infinite_fireapp_model_realms_GroupRealmProxyInterface) object).realmGet$createdByNumber();
        ...
        Table.nativeSetLong(tableNativePtr, columnInfo.timestampIndex, rowIndex, ((com_infinite_fireapp_model_realms_GroupRealmProxyInterface) object).realmGet$timestamp(), false);

        RealmList<com.infinite.fireapp.model.realms.User> usersList = ((com_infinite_fireapp_model_realms_GroupRealmProxyInterface) object).realmGet$users();
        if (usersList != null) {
            OsList usersOsList = new OsList(table.getUncheckedRow(rowIndex), columnInfo.usersIndex);
            for (com.infinite.fireapp.model.realms.User usersItem : usersList) {
                Long cacheItemIndexusers = cache.get(usersItem);
                if (cacheItemIndexusers == null) {
                    cacheItemIndexusers = com_infinite_fireapp_model_realms_UserRealmProxy.insert(realm, usersItem, cache);
                }
                usersOsList.addRow(cacheItemIndexusers);
            }
        }

        RealmList<java.lang.String> adminsUidsList = ((com_infinite_fireapp_model_realms_GroupRealmProxyInterface) object).realmGet$adminsUids();
        ...
        Table.nativeSetBoolean(tableNativePtr, columnInfo.onlyAdminsCanPostIndex, rowIndex, ((com_infinite_fireapp_model_realms_GroupRealmProxyInterface) object).realmGet$onlyAdminsCanPost(), false);
        String realmGet$currentGroupLink = ((com_infinite_fireapp_model_realms_GroupRealmProxyInterface) object).realmGet$currentGroupLink();
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        GroupColumnInfo columnInfo = (GroupColumnInfo) realm.getSchema().getColumnInfo(com.infinite.fireapp.model.realms.Group.class);
        long pkColumnIndex = columnInfo.groupIdIndex;
        com.infinite.fireapp.model.realms.Group object = null;
        while (objects.hasNext()) {
            object = (com.infinite.fireapp.model.realms.Group) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.infinite.fireapp.model.realms.Group object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.infinite.fireapp.model.realms.Group.class);
        ...
        if (usersList != null && usersList.size() == usersOsList.size()) {
            ...
            for (int i = 0; i < objects; i++) {
                ...
                Long cacheItemIndexusers = cache.get(usersItem);
                if (cacheItemIndexusers == null) {
                    cacheItemIndexusers = com_infinite_fireapp_model_realms_UserRealmProxy.insertOrUpdate(realm, usersItem, cache);
                }
    ...
    public static com.infinite.fireapp.model.realms.Group createDetachedCopy(com.infinite.fireapp.model.realms.Group realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.infinite.fireapp.model.realms.Group unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.infinite.fireapp.model.realms.Group();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.infinite.fireapp.model.realms.Group) cachedObject.object;
            }
            unmanagedObject = (com.infinite.fireapp.model.realms.Group) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_infinite_fireapp_model_realms_GroupRealmProxyInterface unmanagedCopy = (com_infinite_fireapp_model_realms_GroupRealmProxyInterface) unmanagedObject;
        com_infinite_fireapp_model_realms_GroupRealmProxyInterface realmSource = (com_infinite_fireapp_model_realms_GroupRealmProxyInterface) realmObject;
        ...
        if (currentDepth == maxDepth) {
            ...
            RealmList<com.infinite.fireapp.model.realms.User> managedusersList = realmSource.realmGet$users();
            RealmList<com.infinite.fireapp.model.realms.User> unmanagedusersList = new RealmList<com.infinite.fireapp.model.realms.User>();
            unmanagedCopy.realmSet$users(unmanagedusersList);
            int nextDepth = currentDepth + 1;
            int size = managedusersList.size();
            for (int i = 0; i < size; i++) {
                com.infinite.fireapp.model.realms.User item = com_infinite_fireapp_model_realms_UserRealmProxy.createDetachedCopy(managedusersList.get(i), nextDepth, maxDepth, cache);
    ...
    static com.infinite.fireapp.model.realms.Group update(Realm realm, com.infinite.fireapp.model.realms.Group realmObject, com.infinite.fireapp.model.realms.Group newObject, Map<RealmModel, RealmObjectProxy> cache) {
        com_infinite_fireapp_model_realms_GroupRealmProxyInterface realmObjectTarget = (com_infinite_fireapp_model_realms_GroupRealmProxyInterface) realmObject;
        com_infinite_fireapp_model_realms_GroupRealmProxyInterface realmObjectSource = (com_infinite_fireapp_model_realms_GroupRealmProxyInterface) newObject;
        ...
        RealmList<com.infinite.fireapp.model.realms.User> usersList = realmObjectSource.realmGet$users();
        RealmList<com.infinite.fireapp.model.realms.User> usersRealmList = realmObjectTarget.realmGet$users();
        if (usersList != null && usersList.size() == usersRealmList.size()) {
            ...
            for (int i = 0; i < objects; i++) {
                ...
                if (cacheusers != null) {
                    ...
                    usersRealmList.set(i, com_infinite_fireapp_model_realms_UserRealmProxy.copyOrUpdate(realm, usersItem, true, cache));
                }
            }
        } else {
            usersRealmList.clear();
            if (usersList != null) {
                for (int i = 0; i < usersList.size(); i++) {
                    ...
                    if (cacheusers != null) {
                        ...
                        usersRealmList.add(com_infinite_fireapp_model_realms_UserRealmProxy.copyOrUpdate(realm, usersItem, true, cache));
                    }
                }
            }
        }
    ...
    public boolean equals(Object o) {
        ...
        com_infinite_fireapp_model_realms_GroupRealmProxy aGroup = (com_infinite_fireapp_model_realms_GroupRealmProxy)o;
